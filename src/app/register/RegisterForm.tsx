...
export function RegisterForm() {
  ...
  const [jobType, setJobType] =
    useState<(typeof JOB_OPTIONS)[number]["value"]>("freelancer");
  ...
  }, [email, password, jobType, city, country, router]);
      ...
      <main className="mx-auto mt-8 w-full max-w-md flex-1">
        <div className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-6 shadow-lg shadow-zinc-900/8 dark:shadow-black/40">
          ...
          <p className="mt-2 text-sm text-[var(--muted)]">
            Tell us where you work so we can tailor deduction hints and future
            country rules.
          </p>
          ...
          <div className="mt-6 space-y-4">
            ...
            <label className="block">
              ...
              <select
                ...
                onChange={(e) =>
                  setJobType(
                    e.target.value as (typeof JOB_OPTIONS)[number]["value"],
                  )
                }
                className="mt-1.5 w-full rounded-xl border border-zinc-300 bg-white px-3 py-2.5 text-base outline-none focus:border-zinc-600 dark:border-zinc-600 dark:bg-zinc-950"
              >
                {JOB_OPTIONS.map((o) => (
            ...
            <label className="block">
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-xl border border-zinc-300 bg-white px-3 py-2.5 text-base outline-none focus:border-zinc-600 dark:border-zinc-600 dark:bg-zinc-950 dark:focus:border-zinc-400"
              />
            </label>
